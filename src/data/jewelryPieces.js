...
const jewelryPieces = [
    {
      ...
      author: "Green Jade",
      detail:
        "This is a beautiful, high-quality jade bangle with a rich, vibrant green color. The jade appears translucent, suggesting it is of good quality. The bangle is likely made from a type of jadeite jade, known for its durability and beauty.",
      thumbnails: [brac1, brac1b],
    },
    {
      titleImg: "Special Lavendar Jade Bracelet",
      author: "Lavendar Jade with malachite accents",
      detail:
        "This is a beautiful lavender jade bead bracelet with accents of malachite. The lavender jade beads are a lovely pale purple color, creating a serene and elegant look. The malachite accents add a touch of vibrant green, contrasting beautifully with the lavender.",
      thumbnails: [brac2, brac2b],
    },
    {
      titleImg: "Lavendar Jade beads Bracelet",
      author: "Lavendar Jade",
      detail:
        "This is a beautiful and elegant lavender jade bead bracelet. The beads are a lovely pale purple color with a subtle translucency, creating a serene and sophisticated look. The bracelet is made of high-quality jade, known for its durability and beauty.",
      thumbnails: [brac3, brac3b],
    },
    {
      ...
      thumbnails: [brac4, brac4b],
    },
    {
      titleImg: "Lavendar Jade Bracelet",
      author: "Lavendar Jade",
      detail:
        "This is a beautiful and elegant lavender jade bangle. The bangle is a lovely pale purple color with a subtle translucency, creating a serene and sophisticated look. The jade appears to be of high quality, with a smooth polished finish.",
      thumbnails: [brac5, brac5b],
    },
    {
      titleImg: "Black Pearl and Diamond Earrings",
      author: "Black Pearl on the top and diamonds engraved on the sides",
      detail:
        "These black pearl and diamond earrings are a breathtaking example of classic jewelry design. The rich color of the pearls is complemented by the dazzling brilliance of the diamonds, creating a look of understated luxury.",
      thumbnails: [ear1, ear1b],
    },
    {
      titleImg: "Classic Diamond Flower Earrings",
      author: "Diamond Earings in flowers shape",
      detail:
        "These exquisite earrings feature a delicate flower design with sparkling diamonds set in a black enamel setting. The classic design is timeless and elegant, making them perfect for any occasion.",
      thumbnails: [ear2, ear2b],
    },
    {
      titleImg: "Modernist Diamond Earrings",
      author:
        " The black enamel provides a striking contrast to the gold and diamonds, creating a visually interesting design.",
      detail:
        "These stunning earrings feature a bold geometric design with black enamel accents. The sparkling diamonds add a touch of luxury and glamour, making them a perfect choice for a special occasion.",
      thumbnails: [ear3, ear3b],
    },
    {
      titleImg: "Classic Jade and Diamond Earrings",
      author:
        "Sparkling diamonds surround the jade, adding a touch of luxury and glamour.",
      detail:
        "These exquisite earrings feature a stunning green jade stone surrounded by a halo of sparkling diamonds. The classic design is timeless and elegant, making them perfect for any occasion.",
      thumbnails: [ear4, ear4b],
    },
    {
      titleImg: "Pearl and Diamond Elegance",
      author:
        "The centerpiece of these earrings is a beautiful white pearl, known for its beauty and elegance which is surounded by diamonds.",
      detail:
        "These exquisite earrings feature a stunning white pearl adorned with sparkling diamonds. The classic design is timeless and elegant, making them perfect for any occasion.",
      thumbnails: [ear5, ear5b],
    },
    {
      titleImg: "Coral Jade and Diamond Earring",
      author:
        "The centerpiece of these earrings is a beautiful coral Jade stone, known for its beauty and elegance which is surounded by diamonds.",
      detail:
        "These exquisite earrings feature a stunning jade stone surrounded by a halo of sparkling diamonds. The classic design is timeless and elegant, making them perfect for any occasion.",
      thumbnails: [ear6, ear6b],
    },
    {
      titleImg: "Radiant Yellow Diamond Halo Ring",
      author:
        "This ring is crafted from 18k white gold, a durable and luxurious metal. The centerpiece is a beautiful sapphire, known for its hardness and rich color. The surrounding diamonds are of high quality, adding to the overall brilliance of the ring.",
      detail:
        "This elegant ring features a stunning oval-cut sapphire surrounded by a halo of sparkling diamonds. The sapphire is a deep blue color, and the diamonds add a touch of brilliance and sparkle. The ring is set in 18k white gold, which complements the sapphire perfectly.",
      thumbnails: [ring1, ring1b],
    },
    {
      titleImg: "Black Rose Ring with Diamonds",
      author:
        "This ring features a delicate rose design with a black enamel center, surrounded by a sparkling halo of diamonds. The rose is a symbol of love and beauty, making this ring a perfect gift for a special occasion.",
      detail:
        "This ring is crafted from 18k yellow gold, a durable and luxurious metal. The black enamel adds a touch of sophistication, while the diamonds provide a dazzling sparkle.",
      thumbnails: [ring2, ring2b],
    },
    {
      titleImg: "Blue Flower Ring with Diamonds",
      author:
        "This ring is crafted from 18k yellow gold, a durable and luxurious metal. The dark blue enamel adds a touch of sophistication, while the diamonds provide a dazzling sparkle.",
      detail:
        "This ring features a stunning floral design with a cluster of diamonds in the center, surrounded by a dark blue enamel border. The intricate details and contrasting colors make this ring a truly unique and eye-catching piece.",
      thumbnails: [ring3, ring3b],
    },
    {
      titleImg: "Swirl Diamond Ring",
      author:
        "This ring features a unique and modern design with a swirling band of baguette-cut diamonds. The diamonds are set in a sleek and contemporary style, creating a dazzling and eye-catching piece.",
      detail:
        "This ring is crafted from 18k white gold, a durable and luxurious metal. The baguette-cut diamonds add a touch of elegance and sophistication, making this ring a perfect choice for a special occasion.",
      thumbnails: [ring4, ring4b],
    },
    {
      titleImg: "Classic Diamond Ring",
      author:
        "This ring is crafted from platinum, a durable and precious metal. The diamonds add a touch of luxury and elegance, making this ring a perfect choice for a special occasion.",
      detail:
        "This ring features a vintage-inspired design with a rectangular shape and a central diamond surrounded by smaller diamonds. The intricate detailing and Art Deco-style motifs make this ring a truly unique and timeless piece.",
      thumbnails: [ring5, ring5b],
    },
    {
      titleImg: "Royal Blue Sapphire Ring",
      author:
        "This ring features a stunning oval-cut sapphire surrounded by a halo of sparkling diamonds. The sapphire is a deep blue color, and the diamonds add a touch of brilliance and sparkle. The ring is set in platinum, a durable and precious metal.",
      detail:
        "This ring is perfect for a woman who wants a unique and eye-catching engagement ring. The sapphire is a symbol of wisdom and loyalty, and the diamonds represent purity and innocence. This ring is sure to be treasured for years to come.",
      thumbnails: [ring6, ring6b],
    },
    {
      titleImg: "Coral Jade and Diamond Ring",
      author:
        "This ring features a stunning oval-cut coral stone surrounded by a delicate diamond setting. The coral is a vibrant orange color, and the diamonds add a touch of sparkle and elegance. The ring is set in 18k white gold, which complements the coral perfectly.",
      detail:
        "This ring is perfect for a woman who wants a unique and eye-catching piece of jewelry. The coral is a symbol of good luck and protection, and the diamonds represent purity and innocence. This ring is sure to be treasured for years to come.",
      thumbnails: [ring7, ring7b],
    },
    {
    ...
    },
    {
      ...
      author:
        "This necklace is crafted from natural coral, a precious gemstone known for its beauty and durability. The diamonds add a touch of sparkle and brilliance, enhancing the overall beauty of the necklace.",
      detail:
        "This necklace features multiple strands of vibrant red coral beads, creating a bold and eye-catching statement. The diamond clasp adds a touch of luxury and elegance, making this necklace a perfect choice for a special occasion.",
      thumbnails: [neck1, neck1b],
    },
    {
    ...
    },
    {
      ...
      detail:
        "This ring is crafted from 18k yellow gold, a durable and luxurious metal. The black and gold enamel adds a touch of sophistication, while the diamond provides a dazzling sparkle.",
      thumbnails: [neck3, neck3b],
    },
    {
      titleImg: "Elegant Black Pearl Necklace",
      author:
        "This necklace is crafted from natural black pearls, a rare and valuable gemstone. Black pearls are often associated with mystery, elegance, and power, making this necklace a truly special piece of jewelry.",
      detail:
        "This necklace features a strand of beautiful black pearls, creating a classic and elegant look. The pearls are perfectly round and lustrous, adding a touch of sophistication to any outfit.",
      thumbnails: [neck4, neck4b],
    },
    {
      titleImg: "Sapphire and Diamond Flower Necklace",
      author:
        "This necklace is crafted from high-quality materials, including sapphires, diamonds, and precious metals. The intricate design and beautiful gemstones make this necklace a truly special and luxurious piece.",
      detail:
        "This necklace features a stunning floral design with alternating sapphire and diamond flowers. The sapphires are a deep blue color, and the diamonds add a touch of brilliance and sparkle. The delicate chain connects the flowers, creating a flowing and elegant look.",
      thumbnails: [neck5, neck5b],
    },
    {
      titleImg: "Elegant Red and White Pearl Necklace",
      author:
        "This necklace is crafted from natural coral and pearls, precious gemstones known for their beauty and durability. The combination of these two gemstones creates a truly unique and luxurious piece of jewelry.",
      detail:
      ...
      thumbnails: [neck6, neck6b],
    },
    {
      titleImg: "Intricate Jade Carving Necklace",
      author:
        "Jade is a precious gemstone known for its beauty and durability. It is often associated with good luck, health, and prosperity, making this necklace a meaningful and beautiful piece of jewelry.",
      detail:
        "This necklace features a stunning carved jade pendant, depicting a beautiful landscape scene. The intricate details and rich colors of the jade make this pendant a true work of art. The pendant is suspended from a delicate chain of small jade beads, adding to the overall elegance of the necklace",
      thumbnails: [neck7, neck7b],
    },
    {
      titleImg: "Mother-of-Pearl and Diamond Necklace",
      author:
        "This necklace is crafted from high-quality materials, including mother-of-pearl, diamonds, and gold. The intricate design and beautiful gemstones make this necklace a truly special and luxurious piece.",
      detail:
      ...
      thumbnails: [neck8, neck8b],
    },
    {
      titleImg: "Dazzling Diamond Waterfall Necklace",
      author:
        "This necklace is crafted from high-quality diamonds and precious metals, making it a truly luxurious and timeless piece. The intricate design and sparkling diamonds make this necklace a perfect choice for a special occasion or as a heirloom piece.",
      detail:
        "This stunning necklace features a dramatic design with a cascading waterfall of baguette-cut diamonds. The diamonds are set in a sleek and modern style, creating a dazzling and eye-catching piece. The necklace also includes a delicate chain of round diamonds, adding a touch of elegance and versatility.",
      thumbnails: [neck9, neck9b],
    },
    {
      titleImg: "Delicate Diamond Filigree Necklace",
      author:
        "The necklace is crafted from high-quality diamonds and precious metals, making it a truly luxurious piece. The intricate design and sparkling diamonds make this necklace perfect for a special occasion or as a heirloom piece.",
      detail:
        "This elegant necklace features a delicate diamond pendant, adorned with intricate filigree detailing. The pendant is suspended from a chain of sparkling diamonds, creating a timeless and sophisticated look.",
      thumbnails: [neck10, neck10b],
    },
    {
      ...
      thumbnails: [neck11, neck11b],
    },
    {
      titleImg: "Vibrant Emerald Bead Necklace",
      author:
        "Emeralds are precious gemstones known for their beauty and durability. They are often associated with love, wisdom, and good fortune, making this necklace a meaningful and beautiful piece of jewelry.",
      detail:
    ...
    },
    {
      ...
      detail:
        "This ring is crafted from 18k yellow gold, a durable and luxurious metal. The black and gold enamel adds a touch of sophistication, while the diamond provides a dazzling sparkle.",
      thumbnails: [neck13, neck13b],
    },
    {
      titleImg: "Chinese Mythology Jade Pendant",
      author:
        "Jade is a precious gemstone known for its beauty and durability. It is often associated with good luck, health, and prosperity, making this necklace a meaningful and beautiful piece of jewelry. The intricate carvings on the pendant add a cultural and historical significance to the piece.",
      detail:
        "This exquisite necklace features a unique jade pendant showcasing intricate carvings of a god and devil. The contrast between the smooth, translucent jade and the detailed carvings creates a stunning visual effect. The pendant is suspended from a colorful beaded necklace, adding to its overall appeal.",
      thumbnails: [neck14, neck14b],
    },
    {
      titleImg: "Chinese Jade Deity Pendant",
      author:
        "Jade is a precious gemstone known for its beauty and durability. It is often associated with good luck, health, and prosperity, making this pendant a meaningful and beautiful piece of jewelry.",
      detail:
    ...
    },
    {
      ...
      author:
        "Jade is a precious gemstone known for its beauty and durability. It is often associated with good luck, health, and prosperity, making this pendant a meaningful and beautiful piece of jewelry.",
      detail:
        "This exquisite pendant features a beautifully carved jade figure, likely depicting a Chinese deity or mythological figure. The intricate details and smooth texture of the jade make this pendant a true work of art. The pendant is adorned with a colorful tassel, adding a touch of elegance and tradition.",
      thumbnails: [uniq1, uniq1b],
    },
    {
      ...
      author:
        "Jade is a precious gemstone known for its beauty and durability. It is often associated with good luck, health, and prosperity, making this pendant a meaningful and beautiful piece of jewelry.",
      detail:
        "This pendant features a beautifully carved jade piece depicting a dragon. The intricate details and vibrant green color of the jade make this pendant a true work of art. The pendant is adorned with a colorful tassel, adding a touch of elegance and tradition.",
      thumbnails: [uniq2, uniq2b],
    },
    // Add more jewelry pieces
  ];

  export default jewelryPieces;
